...
print("program over--------------------------------------------------------------")
'''
singerdata=open('C:/Users/NUTC/Desktop/music-mood-classifier-master/data/singerdata.txt','r')
songdata=open('C:/Users/NUTC/Desktop/music-mood-classifier-master/data/songdata.txt','r')
readinger=singerdata.readlines()
readsong=songdata.readlines()
singerlist = [readsinger.rstrip('\n') for readsinger in open('C:/Users/NUTC/Desktop/music-mood-classifier-master/data/singerdata.txt','r')]
songlist = [readsong.rstrip('\n') for readsong in open('C:/Users/NUTC/Desktop/music-mood-classifier-master/data/songdata.txt','r')]
# songlist = [songdata]
# singerlist=['a','b','c',...]

emotionlabel = []
resultmusic=open("C:/Users/NUTC/Desktop/music-mood-classifier-master/result.txt","w")

for i in range(len(songlist)):
    emotionlabel.append(predict_song(singerlist[i], songlist[i], model))
    resultmusic.write(str(emotionlabel[i])+"\n")

resultmusic.close()

#print(emotionlabel)
#resultmusic.write(str(youtubecollect))
#存成text
#爬蟲結合text因為有情緒然後隨機撥放
#順便存youtube連結